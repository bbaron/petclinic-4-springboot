...
import petclinic.util.Entities;
 ...
 * variable, which uses autowiring <em>by
 * type</em>.
...
public abstract class AbstractClinicServiceTests {
	...
	public void shouldFindAllPetTypes() {
		...
		PetType petType1 = Entities.getById(petTypes, PetType.class, 1);
		assertThat(petType1.getName()).isEqualTo("cat");
		PetType petType4 = Entities.getById(petTypes, PetType.class, 4);
	...
	public void shouldInsertPetIntoDatabaseAndGenerateId() {
		...
		pet.setType(Entities.getById(types, PetType.class, 2));
	...
	public void shouldFindVets() {
		...
		Vet vet = Entities.getById(vets, Vet.class, 3);

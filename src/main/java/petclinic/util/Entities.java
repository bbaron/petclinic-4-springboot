...
public abstract class Entities {
	...
	/**
	 * Alias for {@link #getById(Collection, Class, int) getById}.
	 *
	 * @param entities
	 *            the collection to search
	 * @param entityClass
	 ...
	 *             if the entity was not found
	 */
	public static <T extends BaseEntity> T getEntityById(Collection<T> entities, Class<T> entityClass, int entityId)
			throws ObjectRetrievalFailureException {
		return getById(entities, entityClass, entityId);
	}
}
